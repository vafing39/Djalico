...
export function VideoCard({ item }: { item: any }) {
  ...
  return (
    <View style={styles.videoCard}>
      ...
      <View style={styles.videoInfo}>
        ...
        <View style={styles.videoTags}>
          <View
            style={[
              styles.tag,
              isExpert ? styles.tagExpert : styles.tagBeginner,
            ]}
          >
            <Text
              style={[
                styles.tagText,
                isExpert ? styles.tagTextExpert : styles.tagTextBeginner,
              ]}
            >
              {item.tag}
            </Text>
      ...
      <Pressable style={styles.bookmarkBtn} onPress={() => setSaved(!saved)}>
        <Bookmark
          size={18}
          color={saved ? color.yellowDark : color.softGray}
...
const styles = StyleSheet.create({
  ...
  tagBeginner: {
    backgroundColor: "rgba(181,212,244,0.4)",
  },
  tagText: {
    fontSize: 11,
    fontWeight: "600",
