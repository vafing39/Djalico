...
const translations = {
  fr: {
    ...
    'messages.needPermission': 'Nous avons besoin de votre permission pour afficher la caméra',
    ...
    'calendar.noChildText': 'Ajoutez un enfant dans votre profil pour commencer à utiliser le calendrier.',
    ...
    'calendar.deleteConfirm': 'Êtes-vous sûr de vouloir supprimer cet événement ?',
  ...
  en: {
    ...
    'calendar.noChildText': 'Add a child in your profile to start using the calendar.',
